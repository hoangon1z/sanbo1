...
//            }
        ...
        //合约USDT钱包
        Coin usdt = coinService.findByUnit("USDT");
        ContractWallet contractWallet = new ContractWallet();
        contractWallet.setCoin(usdt);
        contractWallet.setMemberId(json.getLong("uid"));
        contractWallet.setBalance(new BigDecimal(0));
        contractWallet.setFrozenBalance(new BigDecimal(0));
        contractWalletService.save(contractWallet);
        //注册活动奖励

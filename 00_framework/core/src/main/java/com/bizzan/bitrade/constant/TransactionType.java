...
public enum TransactionType implements BaseEnum {
    ...
    public static int parseOrdinal(TransactionType ordinal) {
        if (TransactionType.RECHARGE.equals(ordinal)) {
            ...
            return 16;
        } else if (TransactionType.MINING_FEE.equals(ordinal)) {
            return 17;
        } else if (TransactionType.MINING_OUT.equals(ordinal)) {
            return 18;
        } else if (TransactionType.MINING_IN.equals(ordinal)) {
            return 19;
        } else if (TransactionType.DONATE_IN.equals(ordinal)) {
            return 20;
        } else if (TransactionType.DONATE_OUT.equals(ordinal)) {
            return 21;
        } else if (TransactionType.WELFARE_IN.equals(ordinal)) {
            return 22;
        } else return 23;
    }

...
//     * 原始日产出
//     */
//    @Column(columnDefinition = "decimal(18,8) comment '矿机算力(适合单一币种，kick使用)'")
//    private BigDecimal miningPower = BigDecimal.ZERO;
     ...
     * 待领取产出 kickout
     */
    @Column(columnDefinition = "decimal(18,8) comment '待领取总产出'")
    private BigDecimal canFetchProfit = BigDecimal.ZERO;
     ...
     * 结算日期
     */
    @Column(columnDefinition = "varchar(30) default '2000-01-01 01:00:00'  comment '结算时间'")
    @NotNull
     ...
     * 结算日期
     */
    @Column(columnDefinition = "varchar(30) default '2000-01-01 01:00:00'  comment '结束日期'")

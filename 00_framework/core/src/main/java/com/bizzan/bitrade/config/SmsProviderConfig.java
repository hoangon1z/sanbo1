...
//        return new ChuangRuiSMSProvider(gateway, username, password, sign,accessKey,accessSecret);
        ...
        if (driverName.equalsIgnoreCase(ChuangRuiSMSProvider.getName())) {
        ...
        } else if (driverName.equalsIgnoreCase(AliYunSMSProvider.getName())) {
            ...
            return new YunpianSMSProvider(gateway, sign);
        } else if (driverName.equalsIgnoreCase(LiasmartSMSProvider.getName())) {
            return new LiasmartSMSProvider(username, password, gateway);
        } else {
            return null;
        }
    }

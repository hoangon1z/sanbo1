...
public class MemberController extends BaseAdminController {
   ...
   /* @RequiresPermissions("member:audit-business")
    ...
    @AccessLog(module = AdminModule.SYSTEM, operation = "更新会员状态")
    public MessageResult updateLevel(Long memberId, Long levelId) {
        memberService.updateMemberLevel(memberId, levelId);

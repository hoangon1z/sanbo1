...
public class MarketController {
    ...
    public List<ContractCoinThumb> findSymbolThumb(ContractCoinType type) {
        List<ContractCoin> coins = coinService.findAllVisible(type);
        List<ContractCoinThumb> thumbs = new ArrayList<>();
        for (ContractCoin coin : coins) {
            ...
            ContractCoinThumb contractCoinThumb = new ContractCoinThumb(coin.getId(), coin.getName(), coin.getType().ordinal(), thumb);
            contractCoinThumb.setZone(coin.getZone());
            thumbs.add(contractCoinThumb);
        }
        return thumbs;
    }
    ...
    public ContractCoin findSymbol(Long id) {

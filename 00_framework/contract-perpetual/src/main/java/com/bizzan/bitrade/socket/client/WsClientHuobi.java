...
public class WsClientHuobi {
    ...
    public void run() {
        ...
        try {
            ...
            WebSocketHuobi ws = new WebSocketHuobi(uri, matchFactory);
    ...
    public void setContractMarketService(ContractMarketService service) {
        this.marketService = service;
    }

    public void setExchangePushJob(ExchangePushJob pushJob) {

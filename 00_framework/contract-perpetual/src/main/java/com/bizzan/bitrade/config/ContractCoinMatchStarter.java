...
import com.bizzan.bitrade.engine.ContractRobot;
...
public class ContractCoinMatchStarter implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        for (ContractCoin coin : contractCoinList) {
            ...
            match.setContractOrderService(contractOrderService);
...
//        log.info("=================== 合约机器人启动初始化 ===================");
//        ContractRobot robot = new ContractRobot();
//        robot.setContractCoinService(contractCoinService);
//        robot.setOrderEntrustService(orderEntrustService);

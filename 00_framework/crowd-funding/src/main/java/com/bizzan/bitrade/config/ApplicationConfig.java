...
public class ApplicationConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new MemberInterceptor())
                ...
                .excludePathPatterns("/funding/enabled")
                .excludePathPatterns("/test/*")
                .excludePathPatterns("/funding/getdetail")
                .excludePathPatterns("/funding/enablewelfare")
                .excludePathPatterns("/funding/getlevel")
                .excludePathPatterns("/funding/indexAmount")
                .excludePathPatterns("/funding/getRandomly");

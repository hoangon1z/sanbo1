...
import { BASEURL, fetch, post, postJson, patch, put, postConfig } from './http.js'
...
//GET获取 "财务管理"=>"合约账单明细"
export const contractDetails = data => fetch('admin/finance/contract-transaction/page-query', data);
...
//post "币币管理" => "控盘机器人"=>"获取控盘数据"
export const getRobotQuotas = data => postJson('admin/exchange/exchange-robot/robot-quota-query', data);

//post "币币管理" => "控盘机器人"=>"存储控盘数据"
export const saveRobotQuotas = data => postJson('admin/exchange/exchange-robot/robot-quota-merge', data);

//POST "币币管理" => "币币订单"
export const queryBBOrder = data => post('admin/exchange/exchange-order/page-query', data);

//POST "众筹管理" => "非医疗众筹"
export const queryCrowdList = data => post('admin/crowd/page-query', data);

//POST "合约管理" => "合约委托订单"
export const queryContractEntrust = data => post('admin/contract/entrust/page-query', data);

//POST "合约管理" => "合约撤销委托订单"
export const cancelContractEntrust = data => post('admin/contract/entrust/cancel', data);

//POST "合约管理" => "合约持仓订单"
export const queryContractOrder = data => post('admin/contract/order/page-query', data);

//POST "合约管理" => "强制平仓"
export const closeContractOrder = data => post('admin/contract/order/close', data);

//POST "合约管理" => "合约"
export const queryContractCoin = data => post('admin/contract/coin/page-query', data);

//POST "合约管理" => "所有合约"
export const queryAllContractCoin = () => post('admin/contract/coin/query');

//POST "合约管理" => "新增合约"
export const addContractCoin = data => post('admin/contract/coin/merge', data);

//POST "币币管理" => "合约"=>"修改"
export const editContractCoin = data => post('admin/contract/coin/alter', data);
...
//POST获取 "法币管理"=>"认证商家"=>"成为承兑商"
export const acceptorTrans = data => post('admin/ctc/acceptor/create', data);
...
export const addActivity = data => postJson('admin/activity/activity/add', data);
...
//意见反馈
export const feedback = () => post('admin/system/feedback/query');
...
//POST获取 "众筹管理"=>"非医疗"=>"通过审核"
export const passCrow = data => post('admin/crowd/passcrow', data);

//POST获取 "众筹管理"=>"非医疗"=>"拒绝审核"
export const refusesCrow = data => post('admin/crowd/refusescrow', data);
//POST获取 "众筹管理"=>"非医疗"=>"获取详情"
export const getDetail = data => post('admin/crowd/getdetail', data);
//POST获取 "众筹管理"=>"医疗"=>"列表"
export const queryMedicalList =  data => post('admin/crowd/querymedicallist', data);
//POST获取 "众筹管理"=>"医疗"=>"通过审核"
export const passmedicalcrow =  data => post('admin/crowd/passmedicalcrow', data);
//POST获取 "众筹管理"=>"医疗"=>"拒绝审核"
export const refusemedicalscrow =  data => post('admin/crowd/refusemedicalscrow', data);
//POST获取 "众筹管理"=>"医疗"=>"获取详情"
export const getmedicaldetail =  data => post('admin/crowd/getmedicaldetail', data);
//POST获取 "线下公益"=>"列表"
export const queryWelfare =  data => post('admin/welfare/querywelfare', data);

//POST获取 "线下公益"=>"通过审核"
export const passWelfare =  data => post('admin/welfare/passwelfare', data);
//POST获取 "线下公益"=>"拒绝审核"
export const refuceWelfare =  data => post('admin/welfare/refucewelfare', data);
//POST获取 "会员等级"=>"查看全部"
export const getAllLevel =  data => post('admin/member/member-level/all', data);
//POST获取 "会员等级"=>"修改默认"
export const updateDefault =  data => post('admin/member/member-level/updatedefault', data);
//POST获取 "会员等级"=>"新增"
export const addLevel =  data => post('admin/member/member-level/add', data);
//POST获取 "会员等级"=>"新增"
export const updateLevel =  data => post('admin/member/member-level/update', data);


//POST获取 "矿机"=>"新增"
export const addMining =  data => post('admin/mining/mining/add', data);

//POST获取 "矿机"=>"分页查询"
export const getAllMining =  data => post('admin/mining/mining/page-query', data);

//POST获取 "矿机"=>"变更状态"
export const updateShow =  data => post('admin/mining/mining/updateshow', data);

//POST获取 "矿机"=>"找到一个"
export const miningDetail =  id => post('admin/mining/mining/getOne', {id: id});

//POST获取 "矿机"=>"修改"
export const miningModify =  data => post('admin/mining/mining/modify', data);

//POST获取 "矿机"=>"分页查询"
export const getMiningOrder =  data => post('admin/mining/order/page-query', data);

//POST获取 "众筹评论"=>"评论列表"
export const conmonList =  data => post('admin/fundingCommon/page-query', data);

//POST获取 "众筹评论"=>"通过评论"
export const passCheck =  data => post('admin/fundingCommon/passCheck', data);

//POST获取 "众筹评论"=>"不通过评论"
export const delineCheck =  data => post('admin/fundingCommon/delineCheck', data);

//POST获取 "会员管理"=>"等级下拉框"
export const getAllLevelValue =  data => post('admin/member/member-level/getAllLevelValue', data);

//POST获取 "会员管理"=>"更新等级"
export const updateMemberLevel =  data => post('admin/member/updateLevel', data);

//POST获取 "众筹公益"=>"获取图片信息"
export const getPicDetail =  data => post('admin/crowd/getPicDetail', data);

//GET获取 "风控数据"=>"获取风控区间"
export const getRiskPeriods =  data => post('admin/risk/risk-data-periods', data);
//GET获取 "风控数据"=>"获取风控历史区间"
export const getRiskHistoryPeriods =  data => post('admin/risk/risk-history-periods', data);
//POST获取 "风控数据"=>"获取风控策略"
export const getRiskStrategys =  data => post('admin/risk/strategy/page-query', data);
//POST获取 "风控数据"=>"添加风控策略"
export const addRiskStrategy =  (data, pass) => postJson('admin/risk/strategy/add?password=' + pass, data);
//POST获取 "风控数据"=>"获取所有用户"
export const getRiskMembers =  data => post('admin/risk/member/page-query', data);
//POST获取 "风控数据"=>"获取风控策略详情"
export const getOneRiskStrategy =  id => post('admin/risk/strategy/get', {id: id});
//POST获取 "风控数据"=>"删除风控策略"
export const delRiskStrategy =  id => post('admin/risk/strategy/del', {id: id});
//POST获取 "风控数据"=>"激活、停用风控策略"
export const activeRiskStrategy =  id => post('admin/risk/strategy/active', {id: id});
//POST获取 "风控数据"=>"整体配置"
export const getRiskSetting =  () => post('admin/risk/risk-setting-query');
//POST获取 "风控数据"=>"整体配置"
export const setRiskSetting =  (data) => post('admin/risk/risk-setting-save', data);
//插入价格
export const addRiskData =  (data) => post('admin/risk/risk-data-add', data);
//查看风控未生效区间
export const getRiskGarbage =  data => post('admin/risk/garbage/page-query', data);

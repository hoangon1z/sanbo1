...
export const otherRouter = {
    ...
    children: [
        ...
        { path: 'mining/mining/CreateMining', title: '新增矿机', name: 'mining:add', component: resolve => { require(['@/views/mining/CreateMining.vue'], resolve); } },
        { path: 'risk/strategy/add', title: '新增策略', name: 'risk:strategy:add', component: resolve => { require(['@/views/risk/AddStrategy.vue'], resolve); } },
    ]
};
...
let findSlideArr = [
    ...
    { id: 238, path: 'robot', icon: 'document', component: resolve => { require(['@/views/exchange/Robot.vue'], resolve) } },
    { id: 228, path: '/swap', icon: 'android-funnel', component: Main }, 
    { id: 229, path: 'spentrust', icon: 'document', component: resolve => { require(['@/views/swap/Entrust.vue'], resolve) } },
    { id: 230, path: 'sporder', icon: 'document', component: resolve => { require(['@/views/swap/Order.vue'], resolve) } },
    { id: 231, path: 'spsetting', icon: 'document', component: resolve => { require(['@/views/swap/Setting.vue'], resolve) } },

    { id: 235, path: '/crowd', icon: 'ios-cloud', component: Main },
    { id: 236, path: 'corwdfunding', icon: 'document', component: resolve => { require(['@/views/crowd/Corwdfunding.vue'], resolve) } },
    ...
    { id: 237, path: 'contract', icon: 'document', component: resolve => { require(['@/views/finance/ContractDetails.vue'], resolve) }},
    { id: 251, path: 'fundingCommon', icon: 'document', component: resolve => { require(['@/views/crowd/FundingCommon.vue'], resolve) }},
    { id: 239, path: 'medicalfunding', icon: 'document', component: resolve => { require(['@/views/crowd/medicalfunding.vue'], resolve) }},
    { id: 241, path: 'welfare', icon: 'document', component: resolve => { require(['@/views/crowd/welfare.vue'], resolve) }},
    { id: 242, path: 'Level', icon: 'document', component: resolve => { require(['@/views/member/Level.vue'], resolve) }},
    { id: 246, path: '/mining', icon: 'social-freebsd-devil', component: Main },
    { id: 247, path: 'mining', icon: 'document', component: resolve => { require(['@/views/mining/Mining.vue'], resolve) }},
    { id: 252, path: 'order', icon: 'document', component: resolve => { require(['@/views/mining/Order.vue'], resolve) }},
    { id: 253, path: 'feedback', icon: 'document', component: resolve => { require(['@/views/system/Feedback.vue'], resolve) }},
    { id: 254, path: '/risk', icon: 'ionic', component: Main },
    { id: 255, path: 'view', icon: 'document', component: resolve => { require(['@/views/risk/View.vue'], resolve) } },
    { id: 256, path: 'strategy', icon: 'document', component: resolve => { require(['@/views/risk/Strategy.vue'], resolve) } },
    { id: 257, path: 'member', icon: 'document', component: resolve => { require(['@/views/risk/Member.vue'], resolve) } },
    { id: 258, path: 'setting', icon: 'document', component: resolve => { require(['@/views/risk/Setting.vue'], resolve) } },
    { id: 259, path: 'position', icon: 'document', component: resolve => { require(['@/views/risk/Position.vue'], resolve) } }
]

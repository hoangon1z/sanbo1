      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            width: 115,
            render: (h ,obj) => {
              let power =  obj.row.power;
              let powerNum =  obj.row.powerNum;
              let txt = "无";
              if (!power||!powerNum||power==''||powerNum=='') {
          ...
          },
          {
            ...
            render: (h ,obj) => {
              return h('span',{
              },obj.row.totalSupply + (obj.row.price?(" / " + obj.row.price + obj.row.acceptUnit):''))
            }
          },
          {
            title: '开始时间',

    ...
    <div class="footer">
      <div class="footer_content">
        <div class="footer_left">
          ...
          <p>Copyright © 2019 - kickstarterkit.com All rights reserved.&nbsp;&nbsp;</p>
          <div class="social-list">
            <ul>
              <Tooltip content="Wechat" theme="dark" placement="top">
                <li>
                  <Icon custom="i-icon iconfont icon-bat" />
                </li>
                <div slot="content">
                    <img style="width: 130px;border-radius: 5px;" src="./assets/images/wechatqrcode.png"></img>
                </div>
              </Tooltip>
              <Tooltip content="https://t.me/kickstarterkit" theme="dark" placement="top">
                <li>
              ...
              <!-- <Tooltip content="https://weibo.com/kickstarterkit" theme="dark" placement="top">
                <li>
                  <Icon custom="i-icon iconfont iconweibo" />
                </li>
              </Tooltip> -->
              <!-- <Tooltip content="https://twitter.com/KICKSTARTERKITGlobal" theme="dark" placement="top">
                <li>
                  <Icon type="logo-twitter" />
                </li>
              </Tooltip>
              <Tooltip content="https://medium.com/@KICKSTARTERKIT" theme="dark" placement="top">
                <li>
                  <Icon custom="i-icon iconfont iconmedium" />
                </li>
              </Tooltip>
              <Tooltip content="https://www.reddit.com/u/kickstarterkitglobal" theme="dark" placement="top">
                <li>
          ...
          <ul>
            ...
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">service@kickstarterkit.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">support@kickstarterkit.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">list@kickstarterkit.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">ceo@kickstarterkit.com</p>
                </div>
              </poptip>
            </li>
          </ul>
  ...
  watch: {
    activeNav: function() {
      switch (this.activeNav) {
        case "nav-exchange":
          window.document.title = (this.lang == "简体中文" ? "交易中心" : "Exchange") + " - KICKSTARTERKIT | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-service":
          window.document.title = (this.lang == "简体中文" ? "公告" : "Announcement") + " - KICKSTARTERKIT | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-about":
          window.document.title = (this.lang == "简体中文" ? "关于" : "About") + " - KICKSTARTERKIT | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-lab":
          window.document.title = (this.lang == "简体中文" ? "公益创新室" : "Lab") + " - KICKSTARTERKIT | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-mining":
          window.document.title = (this.lang == "简体中文" ? "矿机" : "Mining") + " - KICKSTARTERKIT | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-invite":
          window.document.title = (this.lang == "简体中文" ? "全球传递爱" : "Promotion") + " - KICKSTARTERKIT | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        default:
          window.document.title = "KICKSTARTERKIT | KICKSTARTERKIT官网 - 全球比特币交易平台 | 全球数字货币交易平台";
          break;
      }
    },
    $route(to, from) {

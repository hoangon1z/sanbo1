module.exports = {
    common: {
        ...
        set: 'Set',
        update: 'Modify',
        slogan: "Pioneer: Digital finance + crowdfunding = sustainable charitable",
        subslogan: "Little love becomes big love, big love affects the world",
        more: "More",
        please: "Please",
        nodata: "No Records",
        pleaseselect: "Select",
        ...
        welcome:'Welcome',
        become:'Become',
        andReceiveRewards:'And Receive Rewards!',
    },
    header: {
        index: 'Home',
        otc: 'OTC',
        ...
        contractmanage: "Swap",
        activity: "Lightning",
        lab: "Public Welfare Lab",
        ctc: "C2C Exchange",
        labdetail: "kickstarterkit Lab  ●  Sharing innovation results",
    ...
    swap: {
        ...
        closetip: 'Confirm close the position at the counter price? available:',
        ...
        modifyLeverageWrong: "There is a position or a bill at present, unable to switch multiple"
    },
    sectionPage: {
        ...
        brandTitle: "About KICKSTARTERKIT",
        brandDetail: "Fairness | Charity | Enthusiasm | Innovation",
        brandDesc1: "We established the kickstarter crowdfunding website in New York, USA in April 2009. We are committed to supporting and motivating innovative and creative activities. Through crowdfunding, we allow creative people to get the funds they need and help them realize their dreams. In 2010, he won the Best Invention Award from Time Magazine. In 2011, Time Magazine awarded the title of Best Website. In 2014, he was certified by B Corp. In 2015, he became a Public-Benefit Corporation (PBC) from a traditional profitable company. The Chinese founder Perry Chen and his team founded the kickstarterkit charity exchange with the support of many international charity organizations. It makes full use of the features of blockchain technology such as traceability, non-tampering, and data encryption security to establish a global Set a more open, transparent, simple and efficient charity currency and charity financial infrastructure to realize the full-process storage of information and behaviors in the charity process, full-cycle traceability and audit, so as to achieve point-to-point assistance to people affected by disasters in the epidemic , Let people all over the world live a better life.",
        brandDesc2: "With the global outbreak of COVID-19 in 2020, Chinese founder Perry Chen and his team founded the kickstarterkit charity exchange with the support of many international charity organizations, which make full use of the traceability, immutability, and data encryption security of blockchain technology. Characteristic, a more open, transparent, simple, and efficient charity currency and charity financial infrastructure have been established on a global scale to realize the full-process storage of information and behaviors in the process of charity and the full-cycle traceability and audit. Achieve point-to-point assistance to people affected by the epidemic, so that people all over the world can live a better life.",
        gettingstart: "HOT | Beginner's Guide",
        officialstart: "Official Customer Service",
        ...
        baseexchangetips: "How to buy and sell on KICKSTARTERKIT",
    ...
    ctc: {
        ...
        desc:"Crypto assets are managed by KICKSTARTERKIT, and the acceptor provides exchange services for exchange.",
        buyin: "Buy",
        sell: "Sell",
        buyprice: "Buy Price",
        sellprice: "Sell Price",
        ...
        input2tips: "Please enter a number between 2 and 50,000",
        bank: "Bank Card",
        alipay: "Alipay",
        wechatpay: "Wechat",
    ...
    activity: {
        ...
        attend: "Attend",
        buyNow: "Buy now",
        login: "Login to PC buy",
        addCapacityCap:"add capacity cap",
        noUpperLimit:"No upper limit",
        invite:"Invite and buy mining Capacity add",
        minInvite:"Minimum number of friends to invite",
        people:'People',
        ...
        attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of KICKSTARTERKIT.",
        attentiontxt1kj: "1. Different types of mining machines correspond to different capacities.",
        attentiontxt2kj: "2. After participating in the [Cloud mining machine subscription] type of activity, the user cannot cancel the application for participation",
        ...
        submit: "Submit",
        tipsmobile: "Please use PC web（www.kickstarterkit.com）",
    ...
    invite: {
        ...
        mylevelteam: "Team friends",
        mypower: "My mining power",
        mypowerteam: "Team mining power",
        mycommission: "Commission income(USDT)",
        redemptionCode:"Promotion Partner redemption code",
        invitePicture:"Invite picture",
        noDiscount:"No discount",
        noRequest:"No request",
        teamsl:"A 6-person team with first-level friends, computing power",
        teamsl2:"Directly push ",
        teamsl3:" people to become a ",
        teamsl4:" team with a computing power of ",
        scanToLearnMore:"Scan to learn more",
        myInvitationCode:"My invitation code:",
        extrareward: "Additional rewards",
        partnerlevel: "activity level",
        ruledetail: "Rule details",
        ruleprofile1:"[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with KICKSTARTERKIT trading platform. Detailed rules are as follows:",
        ruleprofile2:"The highest rebate ratio",
        ruleprofile3:"The longest rebate period (maximum lifetime rebate)",
        ruleprofile4:"The promotion activities, so that the promoters who have made corresponding efforts can become platform partners in the true sense, and enjoy the bonus of growing together with the KICKSTARTERKIT trading platform! The specific rules are as follows:",
        ruletext1: "1. He donates/I pay the bill/you benefit. (The funds donated to the crowdfunding project on the platform come from the handling fees of various financial activities, and do not need to pay out of their own pockets. The platform calls on financiers to donate their financial handling fees to Crowdfunders, crowdfunders gain, the donors have no loss, the platform takes out part of the revenue to pay for the bill) For details, please refer to the Help Center → Novice Guide → (About him donation/I pay the bill/Your income)",
        ruletext2: "2. All volunteers can participate in charity/me-pay activities, and all the expenses of participating in offline charity activities can apply to the platform for subsidies for offline charity activities. For details, please refer to the Help Center → Novice Guide → (Applying for offline charity activity subsidies for you to do charity, I pay the bill)",
        ruletext3: "3. Charity currency gift card reward activities, by redeeming gift cards to redeem charity cloud mining machines for free, please refer to the help center → beginner's guide → (how to use charity currency gift cards to redeem charity cloud mining machines for free)",
        ruletext4: "4. Invite friends: If A invites B, then B is A's first-level friend, if B invites C, then C belongs to B's first-level friend, and also belongs to A's second-level friend.",
        ruletext5: "5. When inviting friends to register, you need to use the link provided by the inviter or manually enter the inviter's invitation code to become the inviter's first-level friend.",
        ruletext6: "6. All donations are peer-to-peer donations, which reach the recipient's account in real time, can be withdrawn without handling fees, and all use blockchain technology/permanent storage/non-tamperable/open and transparent.",
        ruletext7: "7. More welfare activities are rewarded with grade or currency holding as the weight.",
        ruletext8: "8、TOP10 or TOP100 will be awarded additional incentives by KICKSTARTERKIT from time to time.",
        ...
        ruletext11: "11、The right of final interpretation of this activity belongs to KICKSTARTERKIT.",
        ruleexampletitle: "For Example：",
        ruleexamplecontent1: "If John invites 10 first-level friends, TA's first-level friends invite 8 second-level friends respectively. At this time, John has 10 first-level friends and 80 second-level friends. If each person rents a computer with a computing power of 0.12KB /S is a small cloud valued at 1500USDT, then John’s team computing power is (10+80)×0.12KB/S=10.8KB/S, that is, he is successfully promoted to a V2 charity person, and he can initiate a 30,000 USDT online for himself or others For crowdfunding, you can also apply for a subsidy of 3 thousand USDT offline charity activities. Can enjoy 98% off free subscription currency. With the increase of friends, the production capacity of John's mining machines will also increase drastically. What about the computing power brought by friends' transactions and coin purchases?",
        ...
        lv2: "Nonprofit",
        lv3: "Charity expert",
        lv4: "Charity messenger",
        lv5: "Charity Ambassador",
        lv6: "Charity angel",
        levelonecount: "crowdfunding medical/wish/startup",
        levelonecommission: "Apply for subsidy",
        leveltwocommission: "Free subscription",
        wan:'Ten thousand',
        noPermission:"No Permission",
        partnerdivide: "Upgrade requirements",
        partnerdivide1:"no request",
        partnerdivide2:"A 6-person team with first-level friends, 20KB/S",
        partnerdivide3:"Directly push 2 people to become a V2 team with a computing power of 60KB/S",
        partnerdivide4:"Directly push 3 people to become a V3 team with a computing power of 180KB/S",
        partnerdivide5:"Directly push 3 people to become a V4 team with a computing power of 540KB/S",
        partnerdivide6:"Directly push 3 people to become a V5 team with a computing power of 1620KB/S",
        month: "Months",
        alllife: "Lifetime",
        fold:'Fold',
        ...
        thanks: "Thank you for supporting KICKSTARTERKIT！",
        ...
        pt_tips: "If you have a good idea, please send an email to promotion@KICKSTARTERKIT.com, with a reward after adoption.！",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to KICKSTARTERKIT.COM.",
        pt_card_day: "Days",
    ...
    uc: {
        ...
        finance: {
            ...
            personalassets: 'Exchange Account',
            billdetail: 'Exchange Bill Detail',
            contractassets: 'Contract Account',
            contractbilldetail: 'Contract Bill Detail',
            charge: 'Deposit',
            pickup: 'Withdrawal',
            ...
            contractrecord:{
                ...
                forcedping:'Forced Ping',
                datetip:'Please Select The Search Date Range'
            },
            record: {
                start_end: 'Start-End',
                to: 'To',
                ...
                miningout: "Mining Profit",
                miningin: "Buy Mining",
                donatein: "Donate",
                donateout: "Donate Award",
                welfareIn: "Welfare Award"
            },
            recharge: {
                recharge: 'Deposit',
                symbol: 'Coin',
        ...
        member: {
            ...
            crowdfundingList:"crowdfunding List"
        },
        myCf: {
            medicalCrowdfunding: "Medical Crowdfunding",
            otherCrowdfunding: 'Other Crowdfunding',
            offlineCharity: 'Offline Charity',
        ...
        regist: {
            ...
            smscodetip: 'Enter sms verification code',
            invitationCode: 'Enter the invitation code',
        ...
        safe: {
            ...
            idcard_verifymsg3: "3. Need to hold both hand-held documents and handwritten copy (KICK + name + application date), 'All my actions on this site are my own operations, and I understand the risks involved and willing to bear all the legal consequences of this account.'"
        },
        account: {
        ...
        identity: {
            ...
            become: "Become KICKSTARTERKIT Certified Business and enjoy more transaction privileges",
        ...
        mining: {
            ...
            status2: "Over",
            pending:'Pending',
            fetchdone: "Income received successfully, Please check",
            reminder:"Reminder: Your account can get K coins used to deduct handling fees, and you can get corresponding K coins by participating in crowdfunding donations",
            btn:"Click here to jump",
        }
    },
    cms: {
        ...
        donations: 'donations',
        projectsGetHelp: 'Projects get help',
        faq: 'FAQ',
        notice: 'Announcement',
        ...
        download: "Download",
        downloadslogan: "KICKSTARTERKIT APP - Trade everywhere."
    },
    crowdfunding: {
        totalAmount: 'As of 1 minute ago, there have been',
        totalAmount2: 'USDT total donation amount',
        appdownload: 'Times love donation',
        onlineservice: 'A project get help',
        seeMore: 'See more',
        targetAmount: 'Target amount',
        amountRaised: 'Amount raised',
        ...
        auditAmount:'Current Amount',
        initiateCrowdfunding: 'Crowdfunding',
        applySubsidy: 'Apply subsidy',
        loveReminder: 'Love reminder：',
        loveReminder2: 'The donations you donate can deduct all the handling fees of the platform, and reach the personal account of the project sponsor in real time. The platform does not charge any handling fees. You can see all project fundraising information, donation details, all using blockchain technology, and permanent Preserve, cannot be tampered with, open and transparent, and prevent fraud.',
        allCrowdfunding: 'All crowdfunding',
        allPublicWelfare: "All public welfare",
        crowdfunding: 'crowdfunding',
        lessThan: 'The amount does not exceed',
        publicWelfare: "publicWelfare",
        fundraisingType: "Fundraising type",
        wish: 'Crowdfunding wish',
        medical: 'Crowdfunding medical',
        pioneer: "Crowdfunding pioneer",
        basicInformation: "BasicInformation",
        demandAmount:"Demand amount",
        yuan:"USDT",
        year:"Year",
        maxMoney:"Cannot be greater than",
        fundraisingTitle:"write fundraising title",
        instructions:"write Help instructions",
        fundraisingUse:"Fundraising use",
        ...
        patientType:"Patient certificate type",
        imgTitle:"It is recommended that you upload a positive and optimistic hospital treatment photo of the patient",
        sponsorInfo:"Sponsor info",
        sponsorName:"Sponsor name",
        sponsorType:"Sponsor certificate type",
        idCard:"ID card",
        passport:"Passport",
        idNumber:"ID number",
        medicalInformation:"Medical information",
        otherMaterials:"Other materials",
        estate:"Patient family property",
        carProduction:"Patient's family car",
        income:"Patient family income",
        monetaryAssets:"Patient family financial assets",
        arrears:"Patient's family arrears",
        otherApplications:"Fundraising initiated by other platforms",
        submit:"Submit",
        yes:"yes",
        no:"no",
        applyPublicWelfare:"Apply for subsidy",
        subsidyAmount:"Subsidy amount",
        publicWelfareTitle:"Charity activity title",
        details:"Details",
        initiate:"Initiate",
        ...
        rate:'Donation reward KICK (reward ratio 100.1%)'
    },
    description: {
        title1: 'Security',
        title2: '24H Service',
        ...
        aboutdesc1: "We established the kickstarter crowdfunding website in New York, USA in April 2009. We are committed to supporting and motivating innovative and creative activities. Through crowdfunding, we allow creative people to get the funds they need and help them realize their dreams. In 2010, he won the Best Invention Award from Time Magazine. In 2011, Time Magazine awarded the title of Best Website. In 2014, he was certified by B Corp. In 2015, he became a Public-Benefit Corporation (PBC) from a traditional profitable company. The Chinese founder Perry Chen and his team founded the kickstarterkit charity exchange with the support of many international charity organizations. It makes full use of the features of blockchain technology such as traceability, non-tampering, and data encryption security to establish a global Set a more open, transparent, simple and efficient charity currency and charity financial infrastructure to realize the full-process storage of information and behaviors in the charity process, full-cycle traceability and audit, so as to achieve point-to-point assistance to people affected by disasters in the epidemic , Let people all over the world live a better life.",
        aboutdesc2: "With the global outbreak of COVID-19 in 2020, Chinese founder Perry Chen and his team founded the kickstarterkit charity exchange with the support of many international charity organizations, which make full use of the traceability, immutability, and data encryption security of blockchain technology. Characteristic, a more open, transparent, simple, and efficient charity currency and charity financial infrastructure have been established on a global scale to realize the full-process storage of information and behaviors in the process of charity and the full-cycle traceability and audit. Achieve point-to-point assistance to people affected by the epidemic, so that people all over the world can live a better life.",
        aboutdesc3: "In order to let customers better grasp the investment opportunities, KICKSTARTERKIT.COM adopts flat management in customer service department, and establishes an extremely fast service response mechanism. The asset customer service manager is on-line 7*24H all the year round, providing customers with services such as recharge and cash of assets, and ensuring that customers complete recharge in 25 minutes.",
        aboutdesc4: "KICKSTARTERKIT.COM strictly screens high-quality projects and provides secure and stable asset hosting services. KICKSTARTERKIT.COM upholds the concept of “honesty, justice, enthusiasm and openness”, and strives to create a safe, reliable, efficient and friendly ultimate exchange for users.",
        ...
        apply: "Board Apply",
        coop: "Cooperation",
        community: "KICKSTARTERKIT Community",
        wechat: "Wechat",
        addwechat: "Add 'KICKSTARTERKIT01' as Wechat friends and then enter Wechat community",
        weibo: "Weibo",
        twitter: "Twitter",
        biyong: "Biyong",
        telegram: "Telegram",
    ...
    footer: {
        ...
        notice: 'Announcement',
        gsmc: 'Digital finance + crowdfunding = sustainable charitable',
    ...
    index: {
        ...
        BHBregister: "KICKSTARTERKIT account registration",
        ...
        fenpeijizhi: 'A description of the KICKSTARTERKIT income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, KICKSTARTERKIT will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",

                            ...
                            <div class="account-detail" v-show="choseItem==1">
                                <div class="detail-list">
                                    <Form ref="formValidate1" :model="formValidate1" :rules="ruleValidate" :label-width="85">
                                        ...
                                        <!-- Button -->
                                        <FormItem>
                                            <Button type="primary" @click="handleSubmit('formValidate1')" class="shoujiBtn">{{$t('uc.account.save')}}</Button>
                                ...
                                <div class="detail-list">
                                    <Form ref="formValidate2" :model="formValidate2" :rules="ruleValidate" :label-width="95">
                                      <Row>
                                        ...
                                        <img v-else :alt="$t('uc.account.imgtip')" style="width: 200px;height: 200px;border:1px solid #ccc;border-radius: 10px;" src="../../assets/images/upload_placeholder.png">
                                        <div class="acc_sc">
                                          <Upload ref="upload1" :on-success="aliHandleSuccess" :headers="uploadHeaders" :action="uploadUrl">
                                            <Button icon="ios-cloud-upload-outline">{{$t('uc.safe.upload')}}IMG</Button>
                                          </Upload>
                                        </div>
                                        </Col>
                                        ...
                                        <!-- Button -->
                                        <FormItem>
                                          <Button type="primary" @click="handleSubmit('formValidate2')" class="shoujiBtn">{{$t('uc.account.save')}}</Button>
                                ...
                                <div class="detail-list">
                                    <Form ref="formValidate3" :model="formValidate3" :rules="ruleValidate" :label-width="85">
                                      <Row>
                                        ...
                                        <!-- Button -->
                                        <FormItem>
                                            <Button type="primary" @click="handleSubmit('formValidate3')" class="shoujiBtn">{{$t('uc.account.save')}}</Button>

  ...
  data() {
    return {
      ...
      recordType: [
        ...
        {
          value: 17,
          label: this.$t("uc.finance.record.miningfee")
        },
        {
          value: 18,
          label: this.$t("uc.finance.record.miningout")
        },
        {
          value: 19,
          label: this.$t("uc.finance.record.miningin")
        },
        {
          value: 20,
          label: this.$t("uc.finance.record.donatein")
        },
        {
          value: 21,
          label: this.$t("uc.finance.record.donateout")
        }
      ],
      coinList: [],
      coinType: "",
      ...
      columns.push({
        ...
        render: function(h, params) {
          ...
          if (type == 0) {
            ...
            str = that.$t("uc.finance.record.miningfee");
          } else if (type == 18) {
            str = that.$t("uc.finance.record.miningout");
          } else if (type == 19) {
            str = that.$t("uc.finance.record.miningin");
          } else if (type == 20) {
            str = that.$t("uc.finance.record.donatein");
          } else if (type == 21) {
            str = that.$t("uc.finance.record.donateout");
          } else if (type == 22) {
            str = that.$t("uc.finance.record.welfareIn");
          }else {
            str = "";
          }
          return h("div", str, "");
      ...
      columns.push({
        ...
        render(h, params) {
          return h(
            ...
            that.toFloor(params.row.fee || "0") + (params.row.type==3?' KICK':'')
          );
        }
      });
      columns.push({
        ...
        render(h, params) {
          return h(
            ...
            that.toFloor(params.row.discountFee || "0") + (params.row.type==3?' KICK':'')
          );
        }
      });
      columns.push({
        ...
        render(h, params) {
          return h(
            ...
            that.toFloor(params.row.realFee || "0") + (params.row.type==3?' KICK':'')
          );
        }
      });
      columns.push({

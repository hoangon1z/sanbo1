    ...
    <div id="fullpage">
      ...
      <div class="section" id="page1">
        ...
        <div class="spin-wrap banner-panel">
          ...
          <p class="top_title">{{$t("common.slogan")}}</p>
          <p class="top_title2">{{$t("common.subslogan")}}</p>
      ...
      <div style="width: 100%;background: #141e2c;display:none;">
        <router-link to="/announcement/118930" target="_blank" style="width: 100%;">
          <img src="https://kicks.oss-cn-shanghai.aliyuncs.com/bannerimg.png" style="width: 72%;margin-left: 14%;margin-top: 20px;">
        </router-link>
      </div>
      <div class="section shoujishow" id="page2">
        <div class="page2nav">
...
-->
    ...
    <div class="app_bottom">
      <div class="left_logo">
        ...
        <div style="float:left;height: 40px;line-height:40px;color:#000;"><router-link target="_blank" to="/app">{{$t("cms.downloadslogan")}}</router-link></div>
      </div>
...
.top_title2{
text-align:center;font-size:20px;color:#828ea1;position:absolute;top: 130px;width:100%;letter-spacing:2px;
}
.banner-panel{
...
#pagetips{
  .agent-panel{
    ...
    .title{
      ...
      padding-right: 10px;
      margin-top: 10px;
      float:left;width:220px;border-right:1px solid rgb(28, 44, 72);letter-spacing: 3px;
      .gettingstart{
        color: #FFF;
        text-align: justify;
        height: 20px;
...
@media screen and (max-width:1200px){
 ...
 .top_title2{
text-align:center;font-size:15px;color:#828ea1;position:absolute;top: 80px;width:100%;letter-spacing:2px;
}
 #page6{
  background: #192330;
  min-height: 460px;
...
#page5 {
  ...
  .phone_image {
    ...
    float: left;
    height: 100%;
    background: url("../../assets/images/phone_img.png") no-repeat left 20px;
    background-size: 100%;
  }
}
}

        ...
        <Col :xs="24" :sm="24" :md="4" :lg="4">
          ...
          <Menu class="pc_menu" :active-name="activename" :open-names="opennames" @on-open-change="sss" ref="test" :accordion="true" style="width:100%;">
            ...
            <Submenu name="2">
              ...
              <MenuItem name="2-2">
              <router-link to="/uc/contract-money">{{$t('uc.finance.contractassets')}}</router-link>
              </MenuItem>
              <MenuItem name="2-3">
              <router-link to="/uc/record">{{$t('uc.finance.billdetail')}}</router-link>
              </MenuItem>
              <MenuItem name="2-6">
              <router-link to="/uc/contract-record">{{$t('uc.finance.contractbilldetail')}}</router-link>
              </MenuItem>
              <MenuItem name="2-4">
            ...
            <Submenu name="7">
              <template slot="title">
                <span class="isclick"></span>
                <span class="content">{{$t('uc.member.swap')}}</span>
              </template>
              <MenuItem name="7-1">
              <router-link to="/uc/contract/entrust/current">{{$t('uc.member.curdelegate')}}</router-link>
              </MenuItem>
              <MenuItem name="7-2">
              <router-link to="/uc/contract/entrust/history">{{$t('uc.member.hisdelegate')}}</router-link>
              </MenuItem>
            </Submenu>
            <Submenu name="4">
              <template slot="title">
            ...
            <Submenu name="8">
              <template slot="title">
                <span class="isclick"></span>
                <span class="content">{{$t('uc.member.crowdfunding')}}</span>
              </template>
              <MenuItem name="8-1">
              <router-link to="/uc/crowdfunding/list">{{$t('uc.member.crowdfundingList')}}</router-link>
              </MenuItem>
            </Submenu>
          </Menu>
        </Col>
  ...
  data() {
    return {
      ...
      routeArr: {
        ...
        "/uc/account": "1-2",
        "/uc/money": "2-1",
        "/uc/contract-money": "2-2",
        "/uc/record": "2-3",
        "/uc/contract-record": "2-6",
        "/uc/recharge": "2-4",
        "/uc/withdraw": "2-5",
        "/uc/trade": "2-6",
        "/uc/paydividends": "2-7",
    ...
    link(code) {
      switch (code) {
        ...
        case "3-1":
          ...
          break;
        case "7-1":
          this.$router.push("/uc/contract/entrust/current");
          break;
        case "4-1":
        ...
        case "6-2":
          ...
          break;
        case "8-1":
          this.$router.push("/uc/crowdfunding/list");
          break;
        default:
          this.$router.push("/uc/safe");
          break;

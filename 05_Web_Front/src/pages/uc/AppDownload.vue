  ...
  <div class="login_form app-download">
    <div class="login_right">
      <div style="color: #000;margin-bottom: 60px;padding-top: 160px;width: 100%;text-align:center;z-index: 10;">
        ...
        <p style="font-size:18px;">KICKSTARTERKIT</p>
    ...
    <div class="cover" id="cover" @click="coverClick"><img src="https://kicks.oss-cn-shanghai.aliyuncs.com/2019/appdowncover.png"></img></div>
  </div>
</template>
...
export default {
  data() {
    return {
      country: "中国",
      version: "1.0.0",
      publishTime: "2020/11/05 12:32:00",
      device: "ios"
    };
  },
  watch: {
  ...
  methods: {
    init() {
      ...
      window.document.title = (this.lang == "简体中文" ? "APP下载 - " : "APP Download - ") + "KICKSTARTERKIT | 全球比特币交易平台 | 全球数字货币交易平台";
      this.getVersion();

  ...
  <div class="login_form mob-login">
    <div class="login_right">
      <div style="color: #F90;margin-bottom: 60px;margin-top: 60px;">
        <h1 style="border-left: 5px solid #F90;padding-left: 10px;line-height:30px;height:30px;">KICKSTARTERKIT.COM</h1>
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      window.document.title = (this.lang == "简体中文" ? "新用户注册 - " : "New Register - ") + "KICKSTARTERKIT | 全球比特币交易平台 | 全球数字货币交易平台";
      // this.getAreas();
      // this.initGtCaptcha();
    },
    initGtCaptcha() {

    ...
    <div class="wrapper">
      ...
      <div class="content_wrapper">
        ...
        <div class="content1">
          ...
          <p>{{$t('description.service')}}：service@kickstarterkit.com</p>
          <p>{{$t('description.support')}}：support@kickstarterkit.com</p>
          <p>{{$t('description.apply')}}：apply@kickstarterkit.com</p>
          <p>{{$t('description.report')}}：ceo@kickstarterkit.com</p>
          <p>{{$t('description.coop')}}：coop@kickstarterkit.com</p>
        </div>
        <div class="content1" style="border:none;">
          <h5>{{$t('description.community')}}</h5>
          <!-- <p>{{$t('description.weibo')}}：https://weibo.com/kickstarterkit</p> -->
          <p>{{$t('description.twitter')}}：https://twitter.com/kickstarterkit</p>
          <p>{{$t('description.biyong')}}：https://0.plus/kickstarterkit</p>
          <p>{{$t('description.telegram')}}：https://t.me/kickstarterkit</p>
          <!-- <p>{{$t('description.medium')}}：https://medium.com/@KICKSTARTERKIT</p>
          <p>{{$t('description.reddit')}}：https://www.reddit.com/u/kickstarterkitglobal</p> -->
        </div>
      </div>
    </div>
  </div>

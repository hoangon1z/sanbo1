                ...
                <div class="bd bd_limited" v-show="!showMarket">
                  <Form ref="formValidate">
                    ...
                    <div class="slider-wrap">
                      ...
                      <div class="slider-stop" v-for="item in sliderStep" :key="item" :style="'left: '+item+'%;'" @click="silderGo('sliderBuyLimitPercent',item)">
                ...
                <div class="bd bd_market" v-show="showMarket">
                  <Form ref="formValidate">
                    ...
                    <div class="slider-wrap">
                      ...
                      <div class="slider-stop" v-for="item in sliderStep" :key="item.id" :style="'left: '+item+'%;'" @click="silderGo('sliderBuyMarketPercent',item)">
                        <div class="slider-block"></div>
                      </div>
                    </div>
                ...
                <div class="bd bd_limited" v-show="!showMarket">
                  <Form ref="formValidate">
                    ...
                    <div class="slider-wrap">
                      ...
                      <div class="slider-stop" v-for="item in sliderStep"  :key="item.id" :style="'left: '+item+'%;'" @click="silderGo('sliderSellLimitPercent',item)">
                        <div class="slider-block"></div>
                      </div>
                    </div>
                ...
                <div class="bd bd_market" v-show="showMarket">
                  <Form ref="formValidate">
                    ...
                    <div class="slider-wrap">
                      ...
                      <div class="slider-stop" v-for="item in sliderStep"  :key="item.id" :style="'left: '+item+'%;'" @click="silderGo('sliderSellMarketPercent',item)">
                        <div class="slider-block"></div>
                      </div>
                    </div>
...
export default {
  ...
  methods: {
    ...
    buyWithLimitPrice() {
      ...
      console.log()
      if (
        this.accMul(params["amount"], this.symbolFee) >
        this.wallet.kick
      ) {
        //手续费不足
        this.$Modal.confirm({

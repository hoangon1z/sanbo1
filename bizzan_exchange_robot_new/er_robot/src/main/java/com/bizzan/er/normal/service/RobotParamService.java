...
public class RobotParamService {
	...
	public void update(String coinName, RobotParams params){
        ...
        if(param != null){
            ...
            update.set("type", params.getType());
            update.set("controlDefaultPrice", params.getControlDefaultPrice().setScale(6, BigDecimal.ROUND_DOWN));
            update.set("controlPriceRate", params.getControlPriceRate().setScale(6, BigDecimal.ROUND_DOWN));
            ...
            robotParams.setType(params.getType());
            robotParams.setControlDefaultPrice(params.getControlDefaultPrice().setScale(6, BigDecimal.ROUND_DOWN));
            robotParams.setControlPriceRate(params.getControlPriceRate().setScale(6, BigDecimal.ROUND_DOWN));

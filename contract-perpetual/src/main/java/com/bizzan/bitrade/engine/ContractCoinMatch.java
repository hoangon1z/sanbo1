...
public class ContractCoinMatch {
    ...
    public void run(){
        // 数据库查找订单，加载到列表中
        contractOrderList = contractOrderService.findAllNeedMatch();
        contractOrderEntrustList = contractOrderEntrustService.findAllNeedMatch();
        this.isStarted = true;
    }
    ...
    // 设置合约订单服务
    public void setContractOrderService(ContractOrderService contractOrderService) { this.contractOrderService = contractOrderService; }
    // 添加处理者
